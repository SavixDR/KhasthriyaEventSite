        ...
        <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <div className="md:flex md:items-end md:justify-between">
            <div className="max-w-xl">
              <h2 className="text-4xl font-bold tracking-tight text-[#FFD700] sm:text-5xl">
                Read trusted reviews from our customers
              </h2>

              <p className="mt-6 max-w-lg leading-relaxed text-gray-100">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
            <blockquote className="flex h-full flex-col justify-between bg-black ring-1 ring-[#FFD700] rounded-lg p-6 shadow-sm sm:p-8">
              <div>
              ...
              <footer className="mt-4 text-sm font-medium text-gray-100 sm:mt-6">
                &mdash; Michael Scott
              </footer>
            </blockquote>
