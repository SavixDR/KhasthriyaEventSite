				...
				<div className="w-full -mt-[200px] h-[1000px]">
					<div className="md:mx-20 justify-center items-center lg:items-start flex flex-col lg:flex-row">
						<div className="mx-10 lg:w-1/2 my-20 ">
							<h1 className="text-white text-4xl font-semibold text-center lg:text-left  mb-10 lg:mb-36">
						...
						<div className="w-full lg:w-1/2 my-20">
							<h1 className="text-white text-4xl font-semibold text-center lg:text-left md:mx-10 mb-10">
								Ticket Prices
							</h1>
                  ...
                  {isCheckoutModalOpen && <LoginModal isOpen={isCheckoutModalOpen} handleClose={() => setIsCheckoutModalOpen(false)}>
                    <CheckoutForm/></LoginModal>}
								</div>
							</div>
						</div>
					</div>
