			...
			<div className="lg:w-[368px] xl:w-[368px] max-w-sm p-6 sm:m-12 border border-[#FFD700] rounded-3xl bg-black shadow-[#FFD700]/20 shadow-2xl">
				...
				<div className="mt-2 flex flex-col items-center">
					<h1 className="text-lg xl:text-lg font-extrabold text-white">
						{isForgotPassword ? "Reset Password" : "Sign in to our platform"}
					</h1>
					{message && <p className="mt-4 text-xs text-gray-400">{message}</p>}
					<div className="w-full flex-1 mt-8">
						{!isForgotPassword && (
							<div className="flex flex-col items-center">
								<button
									className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-[#FFD700] text-gray-800 hover:bg-[#b49e1f] flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline"
						...
						{isForgotPassword ? (
							<form onSubmit={handleForgotPassword}>
								...
								/>
								<button
									className="mt-5 tracking-wide font-semibold bg-[#FFD700] text-gray-100 w-full py-4 rounded-lg hover:bg-[#b49e1f] transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
									type="submit"
								>
									<span className="ml-3 text-black">Reset Password</span>
								</button>
							</form>
						) : (
						...
						{!isForgotPassword && (
							<div className="flex mx-auto mt-2 items-center justify-center">
								...
								>
									...
									<p className="flex text-slate-300 mt-2 justify-center items-center align-center text-xs hover:text-[#FFD700] active:text-[#d1b202]">
										SIGN UP
									</p>
								</Link>
							</div>
